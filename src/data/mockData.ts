...
export const devices: Device[] = [
  // 高清摄像头系列
  {
    ...
    lastUpdate: '2025-07-30 14:30:00',
    battery: 85,
    signal: 95,
  },
  {
    ...
    status: 'online',
    location: '厂区东门岗哨监控点',
    lastUpdate: '2025-07-30 14:29:30',
    battery: 91,
    signal: 96,
  },
  {
    ...
    status: 'online',
    location: '生产车间中央监控塔',
    lastUpdate: '2025-07-30 14:30:15',
    battery: 78,
    signal: 89,
  },
  {
    ...
    lastUpdate: '2025-07-30 14:28:45',
    battery: 56,
    signal: 82,
  },
  {
    ...
    status: 'online',
    location: '厂区北围墙监控塔3号',
    lastUpdate: '2025-07-30 14:30:10',
    battery: 94,
    signal: 91,
  },
  {
    ...
    status: 'online',
    location: '主厂房出入口闸机处',
    lastUpdate: '2025-07-30 14:29:50',
    battery: 88,
    signal: 93,
  },
  ...
  // 语音对讲设备系列
  {
    ...
    status: 'online',
    location: '生产车间A区班长岗位',
    lastUpdate: '2025-07-30 14:29:00',
    battery: 92,
    signal: 98,
  },
  {
    ...
    status: 'online',
    location: '设备维修间工具台',
    lastUpdate: '2025-07-30 14:29:45',
    battery: 82,
    signal: 85,
  },
  {
    ...
    status: 'online',
    location: '仓库B区3号叉车',
    lastUpdate: '2025-07-30 14:30:20',
    battery: 71,
    signal: 79,
  },
  {
  ...
  },
  {
    ...
    status: 'online',
    location: '厂区巡检路线B段',
    lastUpdate: '2025-07-30 14:28:30',
    battery: 64,
    signal: 87,
  },
  ...
  // 传感器设备系列
  {
    ...
    lastUpdate: '2025-07-30 14:28:00',
    battery: 76,
    signal: 87,
  },
  {
    ...
    status: 'online',
    location: '仓库B区3号货架顶部',
    lastUpdate: '2025-07-30 14:29:55',
    battery: 68,
    signal: 83,
  },
  {
    ...
    status: 'warning',
    location: '化学品处理区域西南角',
    lastUpdate: '2025-07-30 14:25:00',
    battery: 45,
    signal: 76,
  },
  {
    ...
    lastUpdate: '2025-07-30 14:29:40',
    battery: 88,
    signal: 90,
  },
  {
    ...
    status: 'online',
    location: '主管道A段3号监测点',
    lastUpdate: '2025-07-30 14:30:05',
    battery: 72,
    signal: 86,
  },
  {
    ...
    lastUpdate: '2025-07-30 14:29:25',
    battery: 81,
    signal: 84,
  },
  ...
  },
  {
    ...
    status: 'offline',
    location: '主办公楼消防控制室',
    lastUpdate: '2025-07-30 13:45:00',
    battery: 0,
    signal: 0,
  },
];
...
function generateHotelDevices(): HotelDevice[] {
  ...
  for (let i = 1; i <= HOTEL_CONFIG.DELIVERY_ROBOTS; i++) {
    ...
    isOnline: true,
      ...
      estimatedArrival: '2025-07-30 14:35:00'
    });
  }
  ...
  for (let floor = 1; floor <= HOTEL_CONFIG.FLOORS; floor++) {
    ...
    for (let room = 1; room <= roomsOnFloor; room++) {
      ...
      rooms.push({
        ...
        checkInTime: isOccupied ? '2025-07-30 14:00:00' : undefined,
        ...
        lastCleanTime: '2025-07-30 09:30:00',
...
export const faultWarnings: FaultWarning[] = [
  ...
  // 新增更多预警数据
  {
    ...
    severity: 'critical',
    status: 'active',
    timestamp: '2025-07-30 15:45:00',
    description: '电梯主控制器电源异常，可能导致电梯停运',
    predictedFailureTime: '2025-07-30 16:30:00',
  ...
  },
  {
    ...
    severity: 'critical',
    status: 'active',
    timestamp: '2025-07-30 16:30:00',
    description: '报警器主电源故障，已切换到备用电源',
    predictedFailureTime: '2025-07-30 20:00:00',
  ...
  },
  {
    ...
    severity: 'high',
    status: 'active',
    timestamp: '2025-07-30 16:10:00',
    description: '压缩机过热保护频繁触发',
    predictedFailureTime: '2025-07-30 18:00:00',
...
export const deviceLinkages: DeviceLinkage[] = [
  {
    ...
    executionCount: 24,
    lastExecuted: '2025-07-30 16:00:00'
  },
  {
    id: 'linkage_002',
    name: '节能模式',
    ...
    executionCount: 156,
    lastExecuted: '2025-07-30 13:45:00'
  },
  {
    id: 'linkage_003',
    name: '夜间模式',
